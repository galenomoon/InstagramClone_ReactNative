...
export default function PostActions({ setLike, like, setSave, save , comments}) {
  ...
  return (
    <>
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-around", width: 150, paddingVertical: 5 }}>
        ...
        <MyPress onPress={() => navigation.navigate("Comments", { comments }) } children={<Icon name="chatbubble-outline" size={30} color="#fff" />} />
